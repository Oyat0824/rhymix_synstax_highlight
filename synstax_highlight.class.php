...
class synstax_highlight extends EditorHandler
{
	...
	private function generateCopyButtonScript(): string
	{
		...
		$js .= 'var shakeClass = clickCount >= 7 ? "copy-shake-intense" : "copy-shake";'.PHP_EOL;
		...
		$js .= 'btn.classList.add("copy-message", shakeClass);'.PHP_EOL;
		$js .= 'var timer = setTimeout(function() { btn.textContent = originalText; btn.classList.remove("copy-message", shakeClass); btn.removeAttribute("data-copy-timer"); }, 2500);'.PHP_EOL;
